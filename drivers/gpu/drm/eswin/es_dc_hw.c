...
static const struct es_dc_info dc_info[] = {
	{
		...
		.max_bpc = 10,
		.color_formats = 1 << DRM_OUTPUT_COLOR_FORMAT_RGB444,
	...
	},
	{
		...
		.max_bpc = 10,
		.color_formats =
			(1 << DRM_OUTPUT_COLOR_FORMAT_RGB444) | (1 << DRM_OUTPUT_COLOR_FORMAT_YCBCR444) |
			(1 << DRM_OUTPUT_COLOR_FORMAT_YCBCR422) | (1 << DRM_OUTPUT_COLOR_FORMAT_YCBCR420),
