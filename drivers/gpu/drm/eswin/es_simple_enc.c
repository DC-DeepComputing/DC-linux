...
static int encoder_atomic_check(struct drm_encoder *encoder,
...
static const struct of_device_id simple_encoder_dt_match[] = {
	{ .compatible = "eswin,eic7700-hdmi-encoder", .data = &hdmi_priv },
	{ .compatible = "eswin,eic7700-dp-encoder", .data = &hdmi_priv },
	{ .compatible = "eswin,eic7700-dsi-encoder", .data = &dsi_priv },
	{},
};
