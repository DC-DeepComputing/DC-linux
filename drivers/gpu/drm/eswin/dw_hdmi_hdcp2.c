...
static void eswin_hdmi_hdcp2_remove(struct platform_device *pdev)
{
...
static const struct dev_pm_ops dw_hdcp2_pm = {
	SYSTEM_SLEEP_PM_OPS(dw_hdcp2_suspend,dw_hdcp2_resume)
};

static const struct of_device_id dw_hdmi_hdcp2_dt_ids[] = {
	{
		.compatible = "eswin,eic7700-dw-hdmi-hdcp2",
	},
};
